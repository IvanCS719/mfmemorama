function MemoMessage({ mostrarMensajesAction, mostrarCombo, combo }) {
    ...
    return (
        <div className={`fixed z-50 w-full flex items-center justify-center font-fontGeneral text-center font-bold ${mostrarMensajesAction ? 'opacity-100 scale-100' : 'opacity-0 scale-0 pointer-events-none'}`}>
